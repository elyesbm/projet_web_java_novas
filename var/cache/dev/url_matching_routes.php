...
return [
    ...
    [ // $staticRoutes
        ...
        '/admin/skills/parcours' => [[['_route' => 'app_admin_learning_path_index', '_controller' => 'App\\Controller\\Admin\\LearningPathAdminController::index'], null, ['GET' => 0], null, true, false, null]],
        '/admin/skills/parcours/new' => [[['_route' => 'app_admin_learning_path_new', '_controller' => 'App\\Controller\\Admin\\LearningPathAdminController::new'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        ...
        '/admin/skills/new' => [[['_route' => 'app_admin_skills_new', '_controller' => 'App\\Controller\\Admin\\SkillAdminController::new'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        ...
        0 => '{^(?'
                ...
                .'|/admin/(?'
                    ...
                    .'|skills/(?'
                        ...
                        .'|(\\d+)/delete(*:359)'
                    .')'
                    .'|marketplace/([^/]++)/edit(*:393)'
                    .'|publications/([^/]++)/edit(*:427)'
                    .'|users/([^/]++)/edit(*:454)'
                .')'
                .'|/jobs/(?'
                    .'|offre/(?'
    ...
    [ // $dynamicRoutes
        ...
        300 => [[['_route' => 'app_admin_learning_path_edit', '_controller' => 'App\\Controller\\Admin\\LearningPathAdminController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        320 => [[['_route' => 'app_admin_learning_path_delete', '_controller' => 'App\\Controller\\Admin\\LearningPathAdminController::delete'], ['id'], ['POST' => 0], null, false, false, null]],
        339 => [[['_route' => 'app_admin_skills_edit', '_controller' => 'App\\Controller\\Admin\\SkillAdminController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        359 => [[['_route' => 'app_admin_skills_delete', '_controller' => 'App\\Controller\\Admin\\SkillAdminController::delete'], ['id'], ['POST' => 0], null, false, false, null]],
        393 => [[['_route' => 'app_admin_marketplace_edit', '_controller' => 'App\\Controller\\Admin\\MarketplaceAdminController::edit'], ['id'], null, null, false, false, null]],
        427 => [[['_route' => 'app_admin_publications_edit', '_controller' => 'App\\Controller\\Admin\\PublicationAdminController::edit'], ['id'], null, null, false, false, null]],
        454 => [[['_route' => 'app_admin_users_edit', '_controller' => 'App\\Controller\\Admin\\UserAdminController::edit'], ['id'], null, null, false, false, null]],
        486 => [[['_route' => 'app_jobs_detail', '_controller' => 'App\\Controller\\Front\\JobsController::detail'], ['id'], null, null, false, true, null]],
        508 => [[['_route' => 'app_jobs_postuler', '_controller' => 'App\\Controller\\Front\\JobsController::postuler'], ['id'], ['POST' => 0], null, false, false, null]],
        530 => [[['_route' => 'app_jobs_modifier', '_controller' => 'App\\Controller\\Front\\JobsController::modifier'], ['id'], null, null, false, false, null]],
        553 => [[['_route' => 'app_jobs_supprimer', '_controller' => 'App\\Controller\\Front\\JobsController::supprimer'], ['id'], null, null, false, false, null]],
        579 => [[['_route' => 'app_jobs_candidatures', '_controller' => 'App\\Controller\\Front\\JobsController::candidatures'], ['id'], null, null, false, false, null]],
        617 => [[['_route' => 'app_jobs_accepter_candidature', '_controller' => 'App\\Controller\\Front\\JobsController::accepterCandidature'], ['id'], ['POST' => 0], null, false, false, null]],
        638 => [[['_route' => 'app_jobs_refuser_candidature', '_controller' => 'App\\Controller\\Front\\JobsController::refuserCandidature'], ['id'], ['POST' => 0], null, false, false, null]],
        677 => [[['_route' => 'app_learning_path_detail', '_controller' => 'App\\Controller\\Front\\LearningPathController::detail'], ['id'], null, null, false, false, null]],
        714 => [[['_route' => 'app_marketplace_detail', '_controller' => 'App\\Controller\\Front\\MarketplaceController::detail'], ['id'], null, null, false, true, null]],
        736 => [[['_route' => 'app_marketplace_modifier', '_controller' => 'App\\Controller\\Front\\MarketplaceController::modifier'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        780 => [[['_route' => 'app_publication_commenter', '_controller' => 'App\\Controller\\Front\\PublicationController::commenter'], ['id'], ['POST' => 0], null, false, false, null]],
        796 => [[['_route' => 'app_publication_signaler', '_controller' => 'App\\Controller\\Front\\PublicationController::signaler'], ['id'], null, null, false, false, null]],
        835 => [[['_route' => 'app_reservation_reserver', '_controller' => 'App\\Controller\\Front\\ReservationController::reserver'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        868 => [[['_route' => 'app_skills_modifier', '_controller' => 'App\\Controller\\Front\\SkillController::modifier'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        891 => [
            [['_route' => 'app_skills_supprimer', '_controller' => 'App\\Controller\\Front\\SkillController::supprimer'], ['id'], ['POST' => 0], null, false, false, null],
