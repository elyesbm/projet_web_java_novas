...
return [
    ...
    [ // $staticRoutes
        ...
        '/marketplace/article/ajouter-public' => [[['_route' => 'app_marketplace_ajouter_public', '_controller' => 'App\\Controller\\Front\\MarketplaceController::ajouterPublic'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        '/marketplace/categories' => [[['_route' => 'app_marketplace_categories', '_controller' => 'App\\Controller\\Front\\MarketplaceController::categories'], null, null, null, false, false, null]],
        '/marketplace/categorie/ajouter' => [[['_route' => 'app_marketplace_categorie_ajouter', '_controller' => 'App\\Controller\\Front\\MarketplaceController::ajouterCategorie'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        414 => [[['_route' => 'app_jobs_detail', '_controller' => 'App\\Controller\\Front\\JobsController::detail'], ['id'], null, null, false, true, null]],
        436 => [[['_route' => 'app_jobs_postuler', '_controller' => 'App\\Controller\\Front\\JobsController::postuler'], ['id'], ['POST' => 0], null, false, false, null]],
        458 => [[['_route' => 'app_jobs_modifier', '_controller' => 'App\\Controller\\Front\\JobsController::modifier'], ['id'], null, null, false, false, null]],
        481 => [[['_route' => 'app_jobs_supprimer', '_controller' => 'App\\Controller\\Front\\JobsController::supprimer'], ['id'], null, null, false, false, null]],
        507 => [[['_route' => 'app_jobs_candidatures', '_controller' => 'App\\Controller\\Front\\JobsController::candidatures'], ['id'], null, null, false, false, null]],
        545 => [[['_route' => 'app_jobs_accepter_candidature', '_controller' => 'App\\Controller\\Front\\JobsController::accepterCandidature'], ['id'], ['POST' => 0], null, false, false, null]],
        566 => [[['_route' => 'app_jobs_refuser_candidature', '_controller' => 'App\\Controller\\Front\\JobsController::refuserCandidature'], ['id'], ['POST' => 0], null, false, false, null]],
        ...
        648 => [[['_route' => 'app_marketplace_detail', '_controller' => 'App\\Controller\\Front\\MarketplaceController::detail'], ['id'], null, null, false, true, null]],
        670 => [[['_route' => 'app_marketplace_modifier', '_controller' => 'App\\Controller\\Front\\MarketplaceController::modifier'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        693 => [[['_route' => 'app_marketplace_supprimer', '_controller' => 'App\\Controller\\Front\\MarketplaceController::supprimer'], ['id'], ['POST' => 0], null, false, false, null]],
        729 => [[['_route' => 'app_marketplace_categorie_modifier', '_controller' => 'App\\Controller\\Front\\MarketplaceController::modifierCategorie'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        752 => [[['_route' => 'app_marketplace_categorie_supprimer', '_controller' => 'App\\Controller\\Front\\MarketplaceController::supprimerCategorie'], ['id'], ['POST' => 0], null, false, false, null]],
        797 => [[['_route' => 'app_publication_commenter', '_controller' => 'App\\Controller\\Front\\PublicationController::commenter'], ['id'], ['POST' => 0], null, false, false, null]],
        813 => [[['_route' => 'app_publication_signaler', '_controller' => 'App\\Controller\\Front\\PublicationController::signaler'], ['id'], null, null, false, false, null]],
        852 => [
