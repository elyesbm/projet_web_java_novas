 ...
 */
class getOffrejobRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OffrejobRepository' shared autowired service.
     *
     * @return \App\Repository\OffrejobRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OffrejobRepository.php';

        return $container->privates['App\\Repository\\OffrejobRepository'] = new \App\Repository\OffrejobRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
