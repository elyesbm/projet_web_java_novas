...
/* marketplace/mes_articles.html.twig */
class __TwigTemplate_4e1eb5cb3575b48d0d765a5bebe9159d extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "marketplace/mes_articles.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "marketplace/mes_articles.html.twig"));
    ...
    <nav class=\"fixed top-0 w-full z-50 border-b border-white/10 bg-background/80 backdrop-blur-xl\">
        ...
        yield "\" class=\"w-10 h-10 rounded-xl bg-secondary flex items-center justify-center hover:bg-primary/20 transition-colors\">
    ...
    <div class=\"pt-32 pb-24 px-6\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            ...
            yield "                            <tr class=\"hover:bg-secondary/30 transition-colors\">
                                <td class=\"p-4\">
                                    <div class=\"flex items-center gap-4\">
                                        <img src=\"";
            // line 98
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("images/" . CoreExtension::getAttribute($this->env, $this->source, $context["article"], "image", [], "any", false, false, false, 98))), "html", null, true);
            ...
            yield "</h4>
                                ...
                                <td class=\"p-4\">
                                    <span class=\"px-3 py-1 rounded-full text-xs bg-secondary text-muted-foreground\">
                                        ";
            // line 107
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["article"], "categorie", [], "any", false, false, false, 107), "html", null, true);
            yield "
                                    </span>
                                </td>
                                <td class=\"p-4\">
            ...
            // line 111
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["article"], "prix", [], "any", false, false, false, 111), "html", null, true);
            yield " €</p>
                                </td>
                                <td class=\"p-4\">
                                    <span class=\"px-3 py-1 rounded-full text-xs 
                                        ";
            // line 115
            yield (((CoreExtension::getAttribute($this->env, $this->source, $context["article"], "statut", [], "any", false, false, false, 115) == "disponible")) ? ("bg-green-500/20 text-green-400") : ((((CoreExtension::getAttribute($this->env, $this->source,             // line 116
$context["article"], "statut", [], "any", false, false, false, 116) == "reserve")) ? ("bg-yellow-500/20 text-yellow-400") : ("bg-muted text-muted-foreground"))));
            // line 117
            yield "\">
                                        ";
            // line 118
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::capitalize($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["article"], "statut", [], "any", false, false, false, 118)), "html", null, true);
            yield "
                                    </span>
                                </td>
                                <td class=\"p-4\">
                                    <div class=\"flex items-center gap-4 text-sm text-muted-foreground\">
                                        <span class=\"flex items-center gap-1\">
                                            ...
                                            ";
            // line 125
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["article"], "vues", [], "any", false, false, false, 125), "html", null, true);
            yield "
                                        </span>
                                        <span class=\"flex items-center gap-1\">
                                            ...
                                            ";
            // line 129
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["article"], "messages", [], "any", false, false, false, 129), "html", null, true);
            yield "
                                        </span>
                                    </div>
                                </td>
                                <td class=\"p-4\">
                                    <div class=\"flex items-center justify-end gap-2\">
                                        <a href=\"";
            // line 135
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_marketplace_detail", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["article"], "id", [], "any", false, false, false, 135)]), "html", null, true);
            yield "\" class=\"w-10 h-10 rounded-xl bg-secondary flex items-center justify-center hover:bg-white/5 transition-colors\" title=\"Voir\">
                                        ...
                                        <a href=\"";
            // line 138
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_marketplace_modifier", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["article"], "id", [], "any", false, false, false, 138)]), "html", null, true);
...
";
    ...
    {
        return "marketplace/mes_articles.html.twig";
    }
    ...
    {
        return array (  294 => 148,  278 => 138,  272 => 135,  263 => 129,  256 => 125,  246 => 118,  243 => 117,  241 => 116,  240 => 115,  233 => 111,  226 => 107,  216 => 100,  211 => 98,  206 => 95,  202 => 94,  142 => 37,  123 => 21,  117 => 18,  106 => 10,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
    ...
    <nav class=\"fixed top-0 w-full z-50 border-b border-white/10 bg-background/80 backdrop-blur-xl\">
        <div class=\"max-w-7xl mx-auto px-6 h-20 flex items-center justify-between\">
            ...
            <div class=\"flex items-center gap-4\">
                ...
                <a href=\"{{ path('app_user_dashboard') }}\" class=\"w-10 h-10 rounded-xl bg-secondary flex items-center justify-center hover:bg-primary/20 transition-colors\">
                    <i data-lucide=\"user\" class=\"w-5 h-5\"></i>
                </a>
            </div>
        </div>
...
{% endblock %}", "marketplace/mes_articles.html.twig", "C:\\Users\\ASUS\\Desktop\\pidev\\projet_symfony\\templates\\marketplace\\mes_articles.html.twig");
    }
}
