    ...
    <div class=\"pt-32 pb-24 px-6\">
        <div class=\"max-w-3xl mx-auto\">
            <div class=\"text-center mb-8\">
                ...
                <h1 class=\"font-serif text-3xl font-medium mb-2\">Ajouter un produit (article)</h1>
                <p class=\"text-muted-foreground\">Remplissez les champs correspondant à la table Article</p>
            </div>
            
            <form method=\"post\" class=\"glass-card rounded-3xl p-8 space-y-6\">
                <!-- Image (nom du fichier dans images/) -->
                <div>
                    <label class=\"block text-sm font-medium mb-2 text-muted-foreground\">Image (nom du fichier, ex: skills-learning.jpg)</label>
                    <input type=\"text\" name=\"image_article\" placeholder=\"skills-learning.jpg\" class=\"w-full h-12 bg-secondary border border-white/10 rounded-xl px-4 focus:outline-none focus:border-primary transition-all placeholder:text-muted-foreground/50\">
                </div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
            // line 66
            yield "                        <option value=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["cat"], "id", [], "any", false, false, false, 66), "html", null, true);
            yield "\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["cat"], "nom", [], "any", false, false, false, 66), "html", null, true);
            yield "</option>
                        ";
        }
...
";
    ...
    public function block_javascripts(array $context, array $blocks = []): iterable
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["flash"]) {
            // line 120
            yield "        <script>
            // Fallback redirect if server re-renders the same page with a success flash
    ...
    {
        return array (  264 => 122,  260 => 120,  255 => 119,  242 => 118,  218 => 104,  180 => 68,  169 => 66,  165 => 65,  109 => 12,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
...
{% block javascripts %}
    ...
    {% endfor %}
{% endblock %}", "front/marketplace/ajouter.html.twig", "C:\\Users\\khali\\projet_web_java_novas\\templates\\front\\marketplace\\ajouter.html.twig");
    }
}
