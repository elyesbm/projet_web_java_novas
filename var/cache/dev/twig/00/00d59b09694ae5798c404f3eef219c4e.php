...
<div class=\"min-h-screen flex items-center justify-center relative overflow-hidden\">
    ...
    <div class=\"relative w-full max-w-md mx-4\">
        <div class=\"glass-card rounded-3xl p-8 md:p-10 shadow-2xl\">
            ...
            <p class=\"text-center text-sm text-muted-foreground mt-8\">
                Pas encore de compte ? 
                <a href=\"{{ path('app_register') }}\" class=\"text-primary font-medium hover:underline\">Creer un compte</a>
            </p>
        </div>
    </div>
</div>
...
{% endblock %}", "front/auth/login.html.twig", "C:\\Users\\MSI\\Desktop\\projetweb\\projet_web_java_novas\\templates\\front\\auth\\login.html.twig");
    }
}
