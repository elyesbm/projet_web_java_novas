...
$context["article"], "statut", [], "any", false, false, false, 114) == "reserve")) ? ("bg-yellow-500/20 text-yellow-400") : ("bg-muted text-muted-foreground"))));
            ...
            // line 139
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_marketplace_supprimer", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["article"], "id", [], "any", false, false, false, 139)]), "html", null, true);
            yield "\" onsubmit=\"return confirm('Supprimer cet article ?');\">
                                            <input type=\"hidden\" name=\"_token\" value=\"";
            // line 140
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("supprimer_article_" . CoreExtension::getAttribute($this->env, $this->source, $context["article"], "id", [], "any", false, false, false, 140))), "html", null, true);
            yield "\">
...
";
    ...
    {
        return array (  298 => 149,  283 => 140,  279 => 139,  273 => 136,  267 => 133,  258 => 127,  251 => 123,  241 => 116,  238 => 115,  236 => 114,  235 => 113,  228 => 109,  221 => 105,  211 => 98,  206 => 96,  201 => 93,  197 => 92,  137 => 35,  117 => 18,  106 => 10,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
    ...
    <div class=\"pt-32 pb-24 px-6\">
        <div class=\"max-w-7xl mx-auto\">
            ...
            <div class=\"flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8\">
                ...
                <a href=\"{{ path('app_marketplace_ajouter_public') }}\" class=\"flex items-center gap-2 px-6 py-3 bg-primary text-white rounded-xl font-medium hover:bg-primary/90 transition-all shadow-lg shadow-primary/25\">
                    <i data-lucide=\"plus\" class=\"w-5 h-5\"></i>
                    Nouvelle annonce
                </a>
            </div>
                            ...
                            <tr class=\"hover:bg-secondary/30 transition-colors\">
                                ...
                                <td class=\"p-4\">
                                    <div class=\"flex items-center justify-end gap-2\">
                                        ...
                                        <form method=\"post\" action=\"{{ path('app_marketplace_supprimer', {id: article.id}) }}\" onsubmit=\"return confirm('Supprimer cet article ?');\">
...
{% endblock %}", "front/marketplace/mes_articles.html.twig", "C:\\Users\\khali\\projet_web_java_novas\\templates\\front\\marketplace\\mes_articles.html.twig");
    }
}
