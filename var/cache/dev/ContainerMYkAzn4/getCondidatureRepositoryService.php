 ...
 */
class getCondidatureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CondidatureRepository' shared autowired service.
     *
     * @return \App\Repository\CondidatureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CondidatureRepository.php';

        return $container->privates['App\\Repository\\CondidatureRepository'] = new \App\Repository\CondidatureRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
