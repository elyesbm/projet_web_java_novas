 ...
 */
class getLearningPathEtapeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LearningPathEtapeRepository' shared autowired service.
     *
     * @return \App\Repository\LearningPathEtapeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LearningPathEtapeRepository.php';

        return $container->privates['App\\Repository\\LearningPathEtapeRepository'] = new \App\Repository\LearningPathEtapeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
