...
final class Version20260205152132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("CREATE TABLE candidature_job (id_candidature INT AUTO_INCREMENT NOT NULL, offre_id INT NOT NULL, candidat_id INT NOT NULL, message TEXT DEFAULT NULL, statut ENUM('EN_ATTENTE', 'ACCEPTEE', 'REFUSEE') NOT NULL, date_candidature DATETIME NOT NULL, INDEX idx_offre (offre_id), INDEX idx_candidat (candidat_id), UNIQUE INDEX uniq_offre_candidat (offre_id, candidat_id), PRIMARY KEY (id_candidature)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`");
